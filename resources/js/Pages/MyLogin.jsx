        ...
        <>
            ...
            <div className={`w-full h-screen flex flex-col-reverse md:flex-row`}>
                ...
                <div className={`p-6 md:p-20 w-full md:w-1/2 h-screen flex flex-col justify-start items-center md:justify-center md:items-start`}>
                    ...
                    <button className={`flex-center px-5 py-[10px] border-solid border-tertiary rounded-lg border-2 transition-all hover:bg-secondary-100 w-fit`}>
                        <GoogleIcon />
                        <p className={`text-heavy pl-4 w-full text-start`}>Masuk dengan Google.</p>
                    </button>
                </div>
